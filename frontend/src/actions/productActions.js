...
,PRODUCT_UPDATE_REQUEST,PRODUCT_UPDATE_SUCCESS,PRODUCT_UPDATE_FAIL, PRODUCT_CREATE_REVIEW_SUCCESS, PRODUCT_CREATE_REVIEW_FAIL, PRODUCT_CREATE_REVIEW_REQUEST, PRODUCT_EDIT_REVIEW_REQUEST, PRODUCT_EDIT_REVIEW_SUCCESS, PRODUCT_EDIT_REVIEW_FAIL, PRODUCT_TOP_REQUEST, PRODUCT_TOP_SUCCESS, PRODUCT_TOP_FAIL} from '../constants/productConstants'
...
export const productReviewEdit = (productId) => async(dispatch,getState)=>{
    try{
        dispatch({
      ...
      const {data} =   await axios.get(
        ...
        dispatch({type:PRODUCT_EDIT_REVIEW_FAIL,
            payload:error.response && error.response.data.message ? error.response.data.message:error.message})
...
export const listTopProducts = () => async (dispatch)=>{
    ...
    try {
        ...
        const {data} = await axios.get(`/api/products/top`) // adding keyword for search functionality, if keyword is null then we get all products, if not we get those specific products
